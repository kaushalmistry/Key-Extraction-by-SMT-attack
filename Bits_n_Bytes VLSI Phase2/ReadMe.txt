// Assignment: Logic Locking - LL3

Steps to Run the solution code i.e. Solver.py File:-
------------------------------------------------
==> The code is written using python3
==> It requires the below python module to be installed before running the code
    - Module Name: z3-solver
    - Run "pip install z3-solver" command to install the module dependency.
==> Once the setup is ready, run the Solver.py file using "python3 Solver.py" command.
==> It will print the decoded keys in the standard output.
